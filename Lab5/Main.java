...
public class Main {
	...
	public static void main(String[] args) throws FileNotFoundException {
		LinkedList<DomainClient> list = new LinkedList<DomainClient>();
		int user = 0;
		...
		case 3 :
			...
			list.get(user).setNumber(on.nextLine());
		break;
		...
		case 6 :
			...
			list.get(user).setWeight(on.nextLine());
		break;
		...
		case 13 :
			XMLDecoder decoder = new XMLDecoder(
				...
				list =(LinkedList<DomainClient>) decoder.readObject();
				decoder.close();
				break;
